...
My research sits at the intersection of diffusion/flow-based generative modeling and scientific vision: I design training objectives and learning signals that make continuous-time models more sample-efficient, stable, and robust. I’ve also been fortunate to have the opportunity to collaborate with <a href="https://jd92.wang/" target="_blank">Jindong Wang</a> along the way.
</p>

<p>
Recent work includes: (i) <a href="https://arxiv.org/abs/2602.04908" target="_blank">Temporal Pair Consistency (TPC)</a> for variance-reduced Flow Matching; (ii) <a href="https://arxiv.org/abs/2505.21545" target="_blank">CAT-LVDM</a>, a corruption-aware training framework for robust text-to-video diffusion (ICLR 2026 - ReALM-GEN); and (iii) <a href="https://arxiv.org/abs/2505.21545" target="_blank">VideoSAM</a>, a foundation-model adaptation for high-speed video segmentation (IEEE SSD 2025).
